...
# lut-project <img align="right" src="https://user-images.githubusercontent.com/99456326/253195160-df589079-e508-4c30-8bd4-f7acebc43187.svg" width="32px">
...
You can set up your own mod project by using the _Use this template_ button and selecting ***[Create a new repository](https://github.com/new?template_name=lut-project&template_owner=xtaltha)***

After that, make sure to rename the **[lut.cpmodproj](lut.cpmodproj)** file to your desired mod name and also change the _Author_ and/or _Email_ fields in the XML cpmodproj to either blank or your real info, along with _Name_ and _Version_ to the appropriate settings.
...
**[lut-project]** © 2023 by **[xtaltha]** is licensed under **[CC BY-NC-SA 4.0]**
...
[lut-project]: https://github.com/xtaltha/lut-project
